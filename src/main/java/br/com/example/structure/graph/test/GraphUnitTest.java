package br.com.example.structure.graph.test;

import static org.junit.Assert.assertEquals;

import org.junit.Test;

import br.com.example.structure.graph.Graph;
import br.com.example.structure.graph.GraphTraversal;
...
public class GraphUnitTest {
    ...
    public void givenAGraph_whenRemoveVertex_thenVertedNotFound() {
        ...
        assertEquals("[Bob, Alice, Rob, Mark]", GraphTraversal.breadthFirstTraversal(graph, "Bob").toString());
    }
